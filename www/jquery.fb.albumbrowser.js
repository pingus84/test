 ...
 *	Attention changement de api facebook
 * Released under the MIT license
 */

(function ($) {
    $.fn.FacebookAlbumBrowser = function (options,$scope) {
        var defaults = {
		account: "laser13chambery",
                accessToken: "221864991657696|c1eacc5e9d32dba27dff6f114fe0a921",
            showAccountInfo: false,
            showImageCount: false,
            skipEmptyAlbums: true,
            showComments: false,
            commentsLimit: 0,
            skipAlbums: ["Timeline Photos","Cover Photos"],
            includeAlbums: [],
            onlyAlbum: null,
            thumbnailSize: (window.innerWidth/2) - 10,
			thumbnailSizeAlb: (window.innerWidth) - 40,
            ...
            pluginImagesPath: "/",
            albumsPageSize: 10,
            albumsMoreButtonText: "Plus d'albums...",
            photosPageSize: 15,
            photosMoreButtonText: "Plus de photos...",
            checkedPhotos: []
			
        }
		 
$scope.photo="Photos";
		//thumbnailSize=window.innerWidth;
                            ...
                            for (a = 0; a < $(result.data).length; a++) {
                                ...
                                var albumListItem = $("<li>", {
                                   ...
                                   "data-id": $(result.data).get(a).id,
									"style": "height:auto; width:" + settings.thumbnailSize + "px !important"
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (cover) {
                                            ...
                                            if (!$(cover).get(0).error && $(cover).get(0).images) {
												...
												//var albumThumb = $("<img>", { style: "display:none;", "data-id": $(cover).get(0).id, class: "fb-album-thumb", "data-src": "logo.png" , src: "" })
                        ...
                        if (result.data.length > 0) {
                            ...
                            for (a = 0; a < result.data.length; a++) {
                                var photoListItem = $("<li>", {
                                    class: "fb-photo",
                                  "style": "height:auto; width:" + settings.thumbnailSizeAlb + "px !important"
								  //  "style": "height:" + settings.thumbnailSizeAlb + "px !important; width:" + settings.thumbnailSizeAlb + "px !important"
                                });
							 ...
							 var photoThumb = $("<img>", { style: "display:none;", "data-id": $(result.data).get(a).id, class: "fb-photo-thumb", "data-src": albumImg.source, src: "" });
